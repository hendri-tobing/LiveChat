defmodule LiveChat.ChatTest do
  ...
  describe "chat_conversations" do
    alias LiveChat.Chat.Conversation
  ...
  describe "chat_conversation_members" do
    alias LiveChat.Chat.ConversationMember
  ...
  describe "chat_message_reactions" do
    alias LiveChat.Chat.MessageReaction
  ...
  describe "chat_seen_messages" do
    alias LiveChat.Chat.SeenMessage
